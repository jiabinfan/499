...
#         torch.save(model.state_dict(), '/content/drive/My Drive/499/transformer_seq2seq2.pt')
    
#     print(f'Epoch: {epoch+1:02} | Time: {epoch_mins}m {epoch_secs}s')
#     print(f'\tTrain Loss: {train_loss:.3f} | Train PPL: {math.exp(train_loss):7.3f}')
#     print(f'\t Val. Loss: {valid_loss:.3f} |  Val. PPL: {math.exp(valid_loss):7.3f}')

#model.load_state_dict(torch.load('/content/drive/My Drive/499/transformer_seq2seq2.pt',map_location='cpu'))
...
class TreeNode(object):
    ...
    def expand(self, action_priors):
        ...
        action_priors = sorted(action_priors,key = lambda x:x[1])
        action_priors = action_priors[-50:]
        #print(action_priors)
...
#model.load_state_dict(torch.load('/content/drive/My Drive/499/transformer_seq2seq.pt'))
...
for i in range(1000):
    ...
    sentence = open("sentenceCPUbeam=50.txt", 'a')
    ...
    mcts_file = open("mcts_bleuCPUbeam=50.txt", 'a')
    mcts_file.write(str(mcts_bleu) + '\n')
    greedy_file = open("greedy_bleuCPUbeam=50.txt", 'a')
